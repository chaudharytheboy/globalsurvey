...
if(isset($_POST['add'])){
	...
	mysqli_query($conn,"INSERT INTO `products` (`product_name`,`description`,`product_price`,`regular_price`,`shipping`,`quantity`,`review_users`,`url_1`, images, img_popular) VALUES ('$product_name','$description','$product_price','$regular_price','$shipping','$quantity','$review_users','$url_1', '".$target_path1."',
		'".$path1."')");
...
<div class="container" style="margin:4rem 0">
	<div class="row">
		<div class="col-sm-6 col-sm-offset-3">
          ...
          <img src="../<?php echo $data['images'];?>" width="100px;" id="global">
          <input type="file"  name="images" onchange = ChangeImage(this);>
        ...
        <div class="form-group">
                    <label for="exampleInputPassword1">Most Popular / Top Rated / Best Offer Image Uploaded
                        For</label><br />
                    <img src="../<?php echo $data['img_popular'];?>" width="100px;" id="globalimgpopular">
                    <input type="file" name="img_popular" onchange = ChangeImagepop(this);>
